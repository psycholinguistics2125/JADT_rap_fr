...
**Généré le:** 2026-07-06 19:24:21

**Répertoire de sortie:** `/home/robin/Code_repo/psycholinguistic2125/JADT_rap_fr/results/comparisons/comparison_20260706_190605`
...
**Dossier du run:** `results/BERTopic/run_20260126_130645_camembert`
...
|--------|-------|----------------|
| Nombre de topics | 20 | - |
| Ratio d'imbalance | 18.83 | Très déséquilibré |
| Entropie de distribution | 0.978 | Quasi uniforme |
...
|--------|-------|-------------|
| % Spécialistes | 2.6% | Artistes avec >50% dans un topic |
| % Modérés | 11.3% | Artistes avec 25-50% dans le topic dominant |
| % Généralistes | 86.1% | Artistes répartis sur plusieurs topics |
| Indice de spécialisation | 0.189 | Concentration moyenne |
| Divergence JS | 0.460 | Divergence des profils d'artistes |
...
| Métrique | Valeur |
|--------|-------|
| Variance moyenne des topics | 0.000571 |
| JS annuel moyen | 0.0735 |
...
**Topic 0** — *Survie et Rébellion dans la Rue*

- **c-TF-IDF:** la, les, le, de, est, on, dans, des, et, un
- **KeyBERT (15 terms):** as, négro, pas, plus, si, gros, faut, passe, va, dit, sur, sans, rap, ouais, vais

**Topic 1** — *Réalité du Ghetto et Lutte Quotidienne*

- **c-TF-IDF:** la, les, le, est, de, pas, on, dans, des, un
- **KeyBERT (15 terms):** as, pas, fuck, plus, si, gros, dis, va, dit, passe, sont, sur, ouais, est, ta

**Topic 2** — *Relations Complexes et Blessures Émotionnelles*

- **c-TF-IDF:** tu, je, pas, moi, que, ai, est, qu, toi, elle
- **KeyBERT (15 terms):** yeah, si, pas, plus, mal, dis, dit, bébé, qu, tout, dire, ou, même, peux, yeux

**Topic 3** — *Fierté et Résilience dans le Rap*

- **c-TF-IDF:** le, les, la, de, est, on, et, un, pas, des
- **KeyBERT (15 terms):** yeah, flow, as, mc, négro, mec, pas, si, gros, plus, va, rap, dit, ouais, sur

**Topic 4** — *Rébellion et Durcissement dans la Rue*

- **c-TF-IDF:** pas, la, est, les, ai, qu, tu, suis, de, dans
- **KeyBERT (15 terms):** yeah, as, mal, gros, pas, vu, si, sans, faut, plus, ou, ouais, sur, même, dis

**Topic 5** — *Survie et Résilience dans la Rue*

- **c-TF-IDF:** la, pas, les, est, de, le, tu, on, des, ai
- **KeyBERT (15 terms):** as, pas, mal, plus, dis, va, gros, dit, si, aime, sont, ouais, vais, est, toi

**Topic 6** — *Résilience dans la Vie des Quartiers*

- **c-TF-IDF:** pas, est, la, qu, ai, je, moi, tu, on, que
- **KeyBERT (15 terms):** yeah, si, mal, pas, nuit, quoi, plus, bébé, ou, même, mais, dis, peux, qu, oh

**Topic 7** — *Quête de Sens et Émotions Complexes*

- **c-TF-IDF:** je, de, que, est, on, la, et, le, tu, qu
- **KeyBERT (15 terms):** as, mal, pas, dis, plus, dit, si, peut, sur, dire, sont, qu, sans, être, va

**Topic 8** — *Réflexions sur la Vie et la Résilience*

- **c-TF-IDF:** est, de, la, les, le, pas, on, et, des, un
- **KeyBERT (15 terms):** rappe, flow, as, merde, mec, pas, si, gros, plus, va, dit, dis, rap, quoi, ouais

**Topic 9** — *Réflexion sur l'Identité et la Lutte Sociale*

- **c-TF-IDF:** de, les, la, le, et, des, un, est, dans, on
- **KeyBERT (15 terms):** mal, si, pas, peut, plus, sang, mort, vu, faut, sans, sur, ou, peu, même, cette

**Topic 10** — *Titre du thème : "Résilience et Quête d'Identité*

- **c-TF-IDF:** de, la, le, et, je, les, on, est, que, un
- **KeyBERT (15 terms):** nuit, mal, pas, peut, si, plus, mort, ciel, amour, sont, yeux, sur, est, peu, ai

**Topic 11** — *Révolte et Réflexion dans la Rue*

- **c-TF-IDF:** de, les, la, le, et, des, est, on, un, dans
- **KeyBERT (15 terms):** as, mal, pas, plus, si, mort, sur, vu, va, rap, faut, sont, sans, peu, est

**Topic 12** — *Résilience et Quête de Liberté*

- **c-TF-IDF:** la, ouais, est, dans, yeah, oh, le, on, les, de
- **KeyBERT (15 terms):** yeah, yah, aïe, monnaie, na, mal, gang, ya, si, pas, plus, ou, sur, billets, qu

**Topic 13** — *Résilience et Rébellion dans la Rue*

- **c-TF-IDF:** la, les, est, le, dans, pas, on, suis, de, des
- **KeyBERT (15 terms):** yeah, han, bang, ouh, as, hey, fume, gang, putain, pas, fuck, gros, si, pute, plus

**Topic 14** — *Résilience face à l'Oppression Sociale*

- **c-TF-IDF:** la, de, les, pas, est, le, on, des, et, qu
- **KeyBERT (15 terms):** as, mal, pas, si, plus, mort, vu, sans, faut, ou, sur, peu, dit, même, va
...
|------|-----|-----|----------------|
| bertopic_vs_lda | 0.0493 | 0.1256 | Accord faible |
| bertopic_vs_iramuteq | 0.0489 | 0.1285 | Accord faible |
...
2. **Accord le plus faible :** bertopic_vs_lda (NMI = 0.1256)
...
|-------|----------|----------------|
| BERTOPIC | 0.2111 | Association modérée |
...
|--------|-----|-----|-----|----------------|
| BERTOPIC | 0.000590 | 3 | 0.002073 | Stable |
...
|--------|-----|----------------|
| BERTOPIC | 0.6260 | Chevauchement modéré |
...
|-------|---------------|---------|----------|----------------|
| BERTOPIC | 0.8182 | 0.0092 | 20 | Très hétérogène |
...
| Modèle | Distance Moyenne | Écart-type | Topics | Interprétation |
|-------|---------------|---------|----------|----------------|
| BERTOPIC | 0.9742 | 0.0176 | 20 | Très hétérogène |
| LDA | 0.9776 | 0.0052 | 20 | Très hétérogène |
| IRAMUTEQ | 0.9748 | 0.0131 | 20 | Très hétérogène |

**Observations clés :**

1. **Meilleure homogénéité distributionnelle (JS) :** BERTOPIC montre la distance moyenne la plus faible (0.8182).

2. **Meilleure homogénéité lexicale (Labbé) :** BERTOPIC montre la distance moyenne la plus faible (0.9742).
...
| Modèle | JS | Labbé |
|-------|------|-------|
| BERTOPIC | 0.7303 | 0.8030 |
| LDA | 0.7332 | 0.8110 |
| IRAMUTEQ | 0.7345 | 0.8132 |

**Synthèse des 4 configurations :**

- **Meilleure homogénéité (JS):** BERTOPIC (0.8182)
- **Meilleure homogénéité (Labbé):** BERTOPIC (0.9742)
...
|-------|-----------------|----------------|
| T19: Résilience et Vie dans la Rue | 0.7642 | 0.6600 |
| T12: Résilience et Quête de Liberté | 0.3687 | 0.3836 |
| T2: Relations Complexes et Blessures Émotionnelles | 0.3459 | 0.3478 |

**Topics les moins distincts :**

| Topic | Distance Labbé moy. | Distance JS moy. |
|-------|-----------------|----------------|
| T14: Résilience face à l'Oppression Sociale | 0.1845 | 0.2381 |
| T4: Rébellion et Durcissement dans la Rue | 0.1825 | 0.2321 |
| T5: Survie et Résilience dans la Rue | 0.1582 | 0.2150 |
...
|-------|-----|--------|--------|----------|
| BERTOPIC | 6,271,565 | 7,716,683 | 0.8127 | 60,127 |
...
| Model | χ² | N (tokens) | χ²/n | Taille vocab. |
|-------|-----|--------|--------|----------|
| BERTOPIC | 5,573,541 | 7,748,855 | 0.7193 | 43,675 |
...
|-------|------------------|-------------------|----------------|
| BERTOPIC | -0.0374 | 274.2 | 15.1797 |
| LDA | -0.0276 | 219.4 | 11.2640 |
| IRAMUTEQ | -0.0307 | 204.3 | 14.2574 |

*Ratio de séparation SR = inter/intra (agrégation n=72). SR > 1 : distances entre classes supérieures aux distances intra-classe.*

| Model | n=8 | n=24 | n=40 | n=56 | n=72 |
|-------|------|------|------|------|------|
| BERTOPIC | 1.3827 | 2.1707 | 2.9355 | 3.7119 | 4.5227 |
| LDA | 1.3052 | 1.9481 | 2.5936 | 3.2141 | 3.8723 |
| IRAMUTEQ | 1.3071 | 1.9598 | 2.6012 | 3.2329 | 3.8905 |


#### Espace : `camembert` — **circulaire pour BERTopic**
...
| Model | Silhouette (cos) | Calinski-Harabasz | Davies-Bouldin |
|-------|------------------|-------------------|----------------|
| BERTOPIC | -0.0010 | 1,010.9 | 7.3321 |
...
| Model | n=8 | n=24 | n=40 | n=56 | n=72 |
|-------|------|------|------|------|------|
| BERTOPIC | 2.3878 | 5.1712 | 7.8872 | 10.6195 | 13.4588 |
| LDA | 1.5057 | 2.5587 | 3.6354 | 4.6350 | 5.7422 |
| IRAMUTEQ | 1.5071 | 2.5300 | 3.5320 | 4.5648 | 5.5985 |
...
| Model | n=8 | n=24 | n=40 | n=56 | n=72 |
|-------|------|------|------|------|------|
| BERTOPIC | 1.3188 | 1.9805 | 2.6207 | 3.2712 | 3.9502 |
| LDA | 1.2935 | 1.9277 | 2.5563 | 3.1616 | 3.8116 |
| IRAMUTEQ | 1.3158 | 1.9556 | 2.5993 | 3.2329 | 3.8926 |
...
**Q1 — Accord entre modèles :** L'accord le plus fort est observé entre lda vs iramuteq (NMI = 0.2050), tandis que bertopic vs lda montrent l'accord le plus faible (NMI = 0.1256). Ces valeurs modérées à faibles confirment que chaque modèle capture des aspects distincts du corpus.
...
**Q4 — Chevauchement lexical :** Le Jaccard vocabulaire complet entre BERTopic et LDA varie de 0.4272 (seuil=1, vocabulaire fonctionnel partagé) à des valeurs plus faibles aux seuils supérieurs (seuil=5 : 0.4964), confirmant la divergence sur le vocabulaire spécialisé.

**Q5 — Homogénéité intra-topic :** BERTOPIC présente la meilleure homogénéité lexicale (Labbé = 0.9742), BERTOPIC la meilleure homogénéité distributionnelle (JS = 0.8182).
...
- **Timestamp de comparaison:** 2026-07-06 19:24:21
- **Dossier BERTopic:** results/BERTopic/run_20260126_130645_camembert
